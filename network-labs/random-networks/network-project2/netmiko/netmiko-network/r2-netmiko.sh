...
grouped_commands = {
    "SET INTERFACE": [
        ...
        "/interface set ether3 name=eth3.to-r3-netmiko",
    ],

    "SET SERVICES": [
       '/ip service/set ssh port=2520',
       '/ip service/set winbox port=8520',
    ],

    "SET IPADDRESS": [
        "/ip address add address=50.50.50.20/24 interface=eth1.to-sw-netmiko",
        "/ip address add address=50.10.10.2/30 interface=eth2.to-r1-netmiko",
        "/ip address add address=50.20.20.1/30 interface=eth3.to-r3-netmiko",
        "/ip address add address=5.6.6.6/32 interface=lo",
    ...
    "CREATE FIREWALL": [
        ...
        '/ip firewall/filter/add chain=input action=accept protocol=tcp dst-port=2520,8520 src-address-list=input-remote comment="== INPUT REMOTE =="',
        #rip
   ...
   "CREATE USER": [
           "/user add name=r2-netmiko group=full password=r2-netmiko",
        ],
    ...
    "SYSTEM": [
        ...
        '/user/ssh-keys/import public-key-file=ssh.pub user=r2-netmiko',
    ],
   ...
   "Routing": [
       ...
       # interface-template
        '/routing/ospf/interface-template/add area=main-area cost=20 networks=50.10.10.0/30 interfaces=eth2.to-r1-netmiko type=ptp comment="ospf.main-to-r1-netmiko"',
        '/routing/ospf/interface-template/add area=main-area cost=20 networks=50.20.20.0/30 interfaces=eth3.to-r3-netmiko type=ptp comment="ospf.main-to-r3-netmiko"',
        #static-route
